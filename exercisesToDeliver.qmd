...
La esperanza de $T_i$ es la inversa de la $P(coalscencia | n = i)$, donde la $P(coalscencia | n = i) = \binom{i}{2} \frac{1}{2N} = \frac{i(i-1)}{4N}$, entonces la esperanza para un $T_i$ es $\mathbb{E}(T_i)= \frac{4N}{i(i-1)}$.

Para $n=3$ alelos tenemos $T_3$ y $T_2$ entonces la esperanza de $T_{MRCA}$ es $\mathbb{E}[T_{MRCA}] = \mathbb{E}[T_3] + \mathbb{E}[T_2]$
