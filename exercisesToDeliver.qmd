...
El numero esperado de sitios segregantes en una muestra esta dado por $\mathbb{E}(S) = \text{Longitud total de rama} \times \text{Tasa de mutacion} = T_{total} \cdot \mu$
