...
El Site Frequency Spectrum (SFS) es una distribución de frecuencias que resume la variabilidad genética en una poblacion o muestra de secuencias de ADN. El SFS  es un histograma que permite clasificar los sitios segregantes (sitios que varían entre los individuos) según la frecuencia con la que aparece el alelo mutante o derivado en la poblacion o la muestra.
