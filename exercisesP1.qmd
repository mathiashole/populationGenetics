...
Cada intervalo de tiempo tiene un cierto número de linajes que lo “recorren”:

Ttotal=(n1⋅T4)+(n2⋅T3)+(n3⋅T2)
T
total
	​
...
El número esperado de mutaciones es simplemente:
...
S=37
S=37
4. Cálculo de π (diversidad nucleotídica)

π mide las diferencias promedio entre pares de secuencias.

En el coalescente, la esperanza de π es:
...
👉 En la práctica, π dependerá de cómo se reparten las 37 mutaciones en el árbol, pero el valor esperado es π ≈ 20.

5. Cálculo de θW (Theta de Watterson)
...
≈20.18
✅ Resultado final (simulación “a mano”)
