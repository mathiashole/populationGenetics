...
π (diversidad nucleotídica promedio por par)

S (número de sitios segregantes)

θw (estimador de Watterson).
...
El número de pares posibles: 
C(n,2)=n(n−1)/2
C(n,2)=n(n−1)/2.

Y de 
1/(2N)
1/(2N), que es la probabilidad de que un par coalesca en una generación.
...
Probabilidad por generación: 
6/(2N)
6/(2N).

Tiempo esperado:

E[T4]=2N6=1066≈1.67×105
E[T
4
	​
